...
const asTestConfig = asObject({
  env: asOptional(
    asObject({
      ...
      MAESTRO_EDGE_PASSWORD_RECOVERY_Q1: asOptional(asString, 'answr'),
      MAESTRO_EDGE_PASSWORD_RECOVERY_Q2: asOptional(asString, 'answr'),
    ...
    }),
    {
      ...
      MAESTRO_EDGE_PASSWORD_RECOVERY_Q1: 'answr',
      MAESTRO_EDGE_PASSWORD_RECOVERY_Q2: 'answr',

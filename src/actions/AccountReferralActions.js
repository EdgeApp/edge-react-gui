 ...
 */
export const loadAccountReferral =
  (account: EdgeAccount) => async (dispatch: Dispatch, getState: GetState) => {
    // First try the disk:
    try {
...
export const activatePromotion =
  (installerId: string) => async (dispatch: Dispatch, getState: GetState) => {
 ...
 */
export const hideMessageTweak =
  (messageId: string, source: TweakSource) =>
  async (dispatch: Dispatch, getState: GetState) => {
...
export const refreshAccountReferral =
  () => async (dispatch: Dispatch, getState: GetState) => {
    const state = getState()
    const {

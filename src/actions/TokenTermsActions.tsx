...
export const approveTokenTerms = async (account: EdgeAccount, pluginId: string, countryCode: string) => {
  ...
  const body = getUkCompliantString(countryCode, 'token_agreement_modal_message', currencyCode, config.appName)

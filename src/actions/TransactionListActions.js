...
export const fetchMoreTransactions =
  ...
  async (dispatch: Dispatch, getState: GetState): Promise<TransactionListTx[]> => {
    ...
    if (
      ...
      return getAndMergeTransactions(state, dispatch, walletId, currencyCode, {
        startEntries,

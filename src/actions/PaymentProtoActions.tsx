...
export const PAYMENT_PROTOCOL_MAP: MapObject<EdgeAsset> = {
  ...
  USDTe_arb: {
    pluginId: 'arbitrum',
    tokenId: 'fd086bc7cd5c481dcc9c85ebe478a1c0b69fcbb9'
  },
  ETH_base: { pluginId: 'base', tokenId: null },
  USDC_base: {
    pluginId: 'base',
    tokenId: '833589fcd6edb6e08f4c7c32d4f71b54bda02913'
  },
  ...
  BUSD: {
    pluginId: 'ethereum',
    tokenId: '4fabb145d64652a948d72533023f6e7a623c7c53'
  },
  DAI: {
    pluginId: 'ethereum',
  ...
  EUROC: {
    pluginId: 'ethereum',
    tokenId: '1abaea1f7c830bd89acc67ec4af516284b1bc33c'
  },
  GUSD: {
    pluginId: 'ethereum',
    tokenId: '056fd409e1d7a124bd7017459dfea2f387b6d5cd'
  },
  MATIC_e: {
    pluginId: 'ethereum',
  ...
  PAX: {
    pluginId: 'ethereum',
    tokenId: '8e870d67f660d95d5be530380d0ec0bd388289e1'
  },
  PYUSD: {
    pluginId: 'ethereum',
    tokenId: '6c3ea9036406852006290770bedfcaba0e23a0e8'
  },
  SHIB: {
    pluginId: 'ethereum',
  ...
  USDTe_op: {
    pluginId: 'optimism',
    tokenId: '94b008aa00579c1307b0ef2c499ad98a8ce58e58'
  },
  XMR: { pluginId: 'monero', tokenId: null },
  MATIC: { pluginId: 'polygon', tokenId: null },
  BUSD_m: {
    pluginId: 'polygon',
    tokenId: 'dab529f40e671a1d4bf91361c21bf9f0c9712ab7'
  },
  DAI_m: {
    pluginId: 'polygon',
    tokenId: '8f3cf7ad23cd3cadbd9735aff958023239c6a063'
  },
  ETH_m: {
    pluginId: 'polygon',
    tokenId: '7ceb23fd6bc0add59e62ac25578270cff1b9f619'
  },
  SHIB_m: {
    pluginId: 'polygon',
    tokenId: '6f8a06447ff6fcf75d803135a7de15ce88c1d4ec'
  },
  USDC_m: {
    pluginId: 'polygon',
  ...
  USDT_m: {
    pluginId: 'polygon',
    tokenId: 'c2132d05d31c914a87c6611c10748aeb04b58e8f'
  },
  WBTC_m: {
    pluginId: 'polygon',
    tokenId: '1bfd67037b42cf73acf2047067bd4f2c47d9bfd6'
  },
...
async function fetchPaymentProtoJsonResponse(uri: string, init: object): Promise<Response> {
  ...
  if (!fetchResponse.ok || fetchResponse.status !== 200) {
    ...
    throw new PaymentProtoError('FetchFailed', {
      header,
      statusCode,
      text,
      errorData: { uri, method, body, rawText }
    })
  }
...
export async function launchPaymentProto(navigation: NavigationBase, account: EdgeAccount, uri: string, params: LaunchPaymentProtoParams): Promise<void> {
  ...
  if (wallet != null) {
    ...
    if (result?.type !== 'wallet') {
      throw new PaymentProtoError('NoPaymentOption', {
        text: paymentCurrencies.join(', ')
      })
    }

...
export const registerNotificationsV2 = () => async (dispatch: Dispatch, getState: GetState) => {
  ...
  let v2Settings = await getDeviceSettings(deviceId)
...
export const setDeviceSettings = async (deviceId: string, data: DeviceUpdatePayload): Promise<$Call<typeof asDevicePayload>> => {

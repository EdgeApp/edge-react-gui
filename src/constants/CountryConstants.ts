...
export const STATE_PROVINCE_CODES: { [countryCode: string]: StateProvinceData[] } = {
  US: [
...
export const COUNTRY_CODES: CountryData[] = [
  ...
  { name: 'United States of America', filename: 'united-states-of-america', 'alpha-2': 'US', 'alpha-3': 'USA', stateProvinces: STATE_PROVINCE_CODES.US },

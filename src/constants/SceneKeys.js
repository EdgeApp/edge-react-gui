...
export const CREATE_WALLET_ACCOUNT = 'createWalletAccount'
export const CREATE_WALLET_ACCOUNT_SETUP = 'createWalletAccountSetup'
export const CREATE_WALLET_ACCOUNT_LOGIN = 'createWalletAccountLogin'
export const CREATE_WALLET_ACCOUNT_SELECT = 'createWalletAccountSelect'
export const CREATE_WALLET_ACCOUNT_REVIEW = 'createWalletAccountReview'

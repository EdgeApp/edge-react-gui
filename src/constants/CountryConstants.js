...
export const FIAT_COUNTRY: { [string]: { countryName: string, logoUrl: string } } = {
  ...
  KMF: { countryName: '-', logoUrl: '' },
  CDF: { countryName: '-', logoUrl: '' },
  ...
  FKP: { countryName: '-', logoUrl: '' },
  FJD: { countryName: 'FIJI', logoUrl: `${FLAG_LOGO_URL}/fiji.png` },
  XPF: { countryName: '-', logoUrl: '' },
  GMD: { countryName: '-', logoUrl: '' },
  ...
  GBP: { countryName: '-', logoUrl: `${FLAG_LOGO_URL}/united-kingdom.png` },
  ...
  AED: { countryName: '-', logoUrl: '' },
  USN: { countryName: '-', logoUrl: '' },

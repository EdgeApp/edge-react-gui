...
import type {
  VelodromeRouterV2,
  VelodromeRouterV2Interface,
} from "../VelodromeRouterV2";
...
export class VelodromeRouterV2__factory {
  static readonly abi = _abi;
  static createInterface(): VelodromeRouterV2Interface {
    return new utils.Interface(_abi) as VelodromeRouterV2Interface;
  }
  static connect(
    address: string,
    signerOrProvider: Signer | Provider
  ): VelodromeRouterV2 {
    return new Contract(address, _abi, signerOrProvider) as VelodromeRouterV2;
  }
}

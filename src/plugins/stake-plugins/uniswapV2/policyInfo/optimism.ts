...
export const optimismContractInfoMap = {
  ...
  POOL_sAMMV2_ETH_OP: {
    abi: UNISWAP_V2_PAIR,
    address: '0x5404c61F5337D5a06522ca686dc388e0Fc50Fd32'
  },
  POOL_sAMMV2_OP_USDT: {
    abi: UNISWAP_V2_PAIR,
    address: '0x4D8b739114309E4dae98362c447099B671d12ecA'
  },
  POOL_sAMMV2_USDC_DAI: {
    abi: UNISWAP_V2_PAIR,
    address: '0x19715771E30c93915A5bbDa134d782b81A820076'
  },
  POOL_sAMMV2_USDC_USDT: {
    abi: UNISWAP_V2_PAIR,
  ...
  POOL_vAMMV2_USDC_DOLA: {
    abi: UNISWAP_V2_PAIR,
    address: '0x04730579f1468C06530ae3a84B7D5c233f3a130D'
  },
  POOL_vAMMV2_WETH_OP: {
    abi: UNISWAP_V2_PAIR,
    address: '0xd25711EdfBf747efCE181442Cc1D8F5F8fc8a0D3'
  },
  POOL_vAMMV2_WETH_USDC: {
    abi: UNISWAP_V2_PAIR,
    address: '0x0493Bf8b6DBB159Ce2Db2E0E8403E753Abd1235b'
  },
  ...
  */
  // Stable
  GAUGE_sAMMV2_ETH_OP: {
    abi: VELODROME_V2_GAUGE,
    address: '0x5dB64E8050534eE0b41b5295Bf5fcBb402b3CaFA'
  },
  GAUGE_sAMMV2_OP_USDT: {
    abi: VELODROME_V2_GAUGE,
    address: '0x74C97b9aeB2f5b1841Ba99bca6991E8531715E0C'
  },
  GAUGE_sAMMV2_USDC_DAI: {
    abi: VELODROME_V2_GAUGE,
    address: '0x6998089F6bDd9c74C7D8d01b99d7e379ccCcb02D'
  },
  GAUGE_sAMMV2_USDC_USDT: {
    abi: VELODROME_V2_GAUGE,
    address: '0xa2f27d183A4E409c734367712f9344328f8EC98D'
  },
  GAUGE_sAMMV2_WETH_OP: {
    abi: VELODROME_V2_GAUGE,
    address: '0x5dB64E8050534eE0b41b5295Bf5fcBb402b3CaFA'
  },
  // Volatile
  ...
  GAUGE_vAMMV2_ETH_USDC: {
    abi: VELODROME_V2_GAUGE,
    address: '0xE7630c9560C59CCBf5EEd8f33dd0ccA2E67a3981'
  },
  GAUGE_vAMMV2_OP_USDC: {
    abi: VELODROME_V2_GAUGE,
    address: '0x36691b39Ec8fa915204ba1e1A4A3596994515639'
  },
  GAUGE_vAMMV2_USDC_DOLA: {
    abi: VELODROME_V2_GAUGE,
    address: '0x7C07703B1f470b7673bF65aE6d49883AF2cA341e'
  },
  GAUGE_vAMMV2_WETH_OP: {
    abi: VELODROME_V2_GAUGE,
    address: '0xCC53CD0a8EC812D46F0E2c7CC5AADd869b6F0292'
  },
  GAUGE_vAMMV2_WETH_USDC: {
    abi: VELODROME_V2_GAUGE,
    address: '0xE7630c9560C59CCBf5EEd8f33dd0ccA2E67a3981'
  }
}

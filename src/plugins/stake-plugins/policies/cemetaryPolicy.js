...
export const makeCemetaryPolicy = (): StakePluginPolicy => {
      ...
      /*
        LP Liquidity Providing:
          ...
          1. Send Approve TX on Liquidity-Pool-Contract
            ...
            Approve SpookySwap Router contract on TOMB token contract 
            ```
            tokenContract.approve(SpookySwap Router, MAX_UINT256)
          ...
          2. Send supply TX on Liquidity-Pool-Contract
            ...
            Send addLiquidityETH call to SpookySwap Router contract
            ```

  ...
  return (
    <SceneWrapper background="theme">
      <KeyboardAwareScrollView keyboardShouldPersistTaps="handled" extraScrollHeight={theme.rem(2.75)} enableAutomaticScroll enableOnAndroid>
        ...
        <GuiFormField fieldType="address" autofocus label={lstrings.address_line_1} value={formData.address} onChangeText={handleChangeAddress} />
        <GuiFormField fieldType="address2" label={lstrings.address_line_2} value={formData.address2} onChangeText={handleChangeAddress2} />
        <GuiFormField fieldType="city" label={lstrings.address_city} value={formData.city} onChangeText={handleChangeCity} />
        <GuiFormField fieldType="state" label={lstrings.address_state_province_region} value={formData.state} onChangeText={handleChangeState} />
        <GuiFormField

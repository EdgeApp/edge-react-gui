    ...
    <SceneWrapper background="theme">
      <KeyboardAwareScrollView keyboardShouldPersistTaps="handled" extraScrollHeight={theme.rem(2.75)} enableAutomaticScroll enableOnAndroid>
        ...
        <GuiFormField
          ...
          onBlur={handleHideAddressHints}
        />
        <GuiFormField fieldType="city" label={s.strings.address_city} value={formData.city} onChangeText={handleChangeCity} onBlur={handleHideAddressHints} />
        <GuiFormField
          fieldType="state"
          label={s.strings.address_state_province_region}

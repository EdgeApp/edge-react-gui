  ...
  return (
    <SceneWrapper background="theme">
      <KeyboardAwareScrollView keyboardShouldPersistTaps="handled" extraScrollHeight={theme.rem(2.75)} enableAutomaticScroll enableOnAndroid>
        ...
        <View>
          <OutlinedTextInput returnKeyType="next" label={s.strings.account_owner} onChangeText={handleNameInput} value={name} autoFocus />
        </View>
        <View>
          <OutlinedTextInput returnKeyType="next" label={s.strings.iban} onChangeText={handleIbanInput} value={iban} autoFocus={false} />
        </View>
        <View>
          <OutlinedTextInput returnKeyType="done" label={s.strings.swift_bic} onChangeText={handleSwiftInput} value={swift} autoFocus={false} />
        </View>
        <MainButton

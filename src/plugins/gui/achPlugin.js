...
import { type FiatProviderFactory, type FiatProviderGetQuoteParams, type FiatProviderQuote } from './fiatProviderTypes'
import { createStore, debugSpewStore, getBestError, getRateFromQuote } from './pluginUtils'

const providerFactories: FiatProviderFactory[] = []

export const achPlugin: FiatPluginFactory = async (params: FiatPluginFactoryArgs) => {
  const pluginId = 'ach'
  const { showUi, account, direction } = params

  debugSpewStore(account.dataStore)
  // return

    ...
    return (
      <SafeAreaView>
        ...
        <View style={styles.body}>
          <DropdownPicker startOpen autoFocus keyboardShouldPersistTaps={'always'} listItems={supportedFiats || []} placeholder={DEFAULT_FIAT_PICKER_PLACEHOLDER} onSelect={this.onSelectFiat} />
        </View>
      </SafeAreaView>
    )
  }

...
export class BTCSettings extends Component {
  render () {
    return (
      <View style={[s.ethereumSettings, b('brown')]}>
        ...
        <RadioRows style={b('green')} onSelect={(denomination) => this.selectDenomination('BTC', denomination)}>
          {
            this.props.denominations.map(denomination => {
              ...
              const onPress = () => this.props.selectDenomination('BTC', key)
...
export default connect(mapStateToProps, mapDispatchToProps)(BTCSettings)

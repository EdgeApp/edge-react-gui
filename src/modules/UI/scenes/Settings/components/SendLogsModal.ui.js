...
export default class SendLogsModal extends Component {
  ...
  render () {
    const input = <FormField style={styles.sendLogsModalInput} label="Type some text" value={this.state.text} onChangeText={this.onChangeText} returnKeyType="done" />

    const modalBottom = <ModalButtons onDone={this.onDone} onCancel={this.onCancel} />

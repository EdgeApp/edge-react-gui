...
import { View, TouchableOpacity, ActivityIndicator, Animated, FlatList, Image } from 'react-native'
    ...
    return (
      <SafeAreaView>
        <View style={styles.container}>
          ...
          <TouchableOpacity onPress={this.handleOnBalanceBoxPress}>{this.state.balanceBoxVisible ? this.balanceBox(fiatBalanceString) : this.hiddenBalanceBox()}</TouchableOpacity>
            ...
            <Gradient style={[styles.walletsBoxHeaderWrap, UTILS.border()]}>
              ...
              <View style={[styles.donePlusContainer, UTILS.border()]}>
                ...
                {this.state.fullListExists && (
                  ...
                  >
                    <TouchableOpacity style={[styles.walletsBoxHeaderAddWallet, { width: 41 }]} onPress={Actions[Constants.CREATE_WALLET_NAME]}>
    ...
    return (
      <View style={[styles.listsContainer, UTILS.border()]}>
        {this.state.sortableListExists && (
          <Animated.View
            testID={'sortableList'}
            style={[UTILS.border(), { flex: 1, opacity: this.state.sortableListOpacity, zIndex: this.state.sortableListZIndex }, styles.sortableList, UTILS.border()]}
          >
            <SortableListView
              style={{ flex: 1, width }}

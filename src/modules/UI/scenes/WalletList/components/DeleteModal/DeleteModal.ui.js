  ...
  render () {
    return (
      <StylizedModal
        ...
        modalMiddle={<OptionSubtext confirmationText={s.strings.fragmet_wallets_delete_wallet_first_confirm_message_mobile} label={s.strings.fragment_wallets_delete_wallet} />}

  ...
  render () {
    return (
      <StylizedModal
        ...
        modalMiddle={<OptionSubtext confirmationText={s.strings.fragment_wallets_resync_wallet_first_confirm_message_mobile} label={s.strings.fragment_wallets_resync_wallet} />}

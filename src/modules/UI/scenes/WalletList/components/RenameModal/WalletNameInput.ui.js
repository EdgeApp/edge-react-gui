  ...
  render () {
    return (
      <View style={[styles.nameInputWrap]}>
        <FormField autoCapitalize="words" style={[styles.nameInput]} onChangeText={this._onNameInputChange} value={this.state.currentWalletNameInput} label={this.props.label} autoFocus />
      </View>
    )
  }
}

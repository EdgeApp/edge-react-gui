...
import { View, TouchableHighlight, Image, Platform, ActivityIndicator } from 'react-native'
...
class SortableWalletListRow extends Component<Props, State> {
  render () {
    ...
    return (
      <TouchableHighlight style={[styles.rowContainer, styles.sortableWalletListRow]} underlayColor={styleRaw.walletRowUnderlay.color} {...this.props.sortHandlers}>
          ...
          <View style={[styles.rowContent, b()]}>
            ...
            <View style={[styles.rowBalanceTextWrap, b()]}>
              ...
              <View style={{ flexDirection: 'row', justifyContent: 'flex-end' }}>
                ...
                <T> (</T>
                <T style={[styles.rowBalanceDenominationText]}>{symbol || ''}</T>
                <T>)</T>
              </View>
            </View>

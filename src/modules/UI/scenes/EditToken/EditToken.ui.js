      ...
      <SafeAreaView>
        <View style={[styles.editTokens]}>
          ...
          <StylizedModal
            ...
            modalBottom={<DeleteTokenButtons onPressDelete={this.deleteToken} onPressCancel={() => this.props.hideDeleteTokenModal()} processingFlag={this.props.deleteCustomTokenProcessing} />}

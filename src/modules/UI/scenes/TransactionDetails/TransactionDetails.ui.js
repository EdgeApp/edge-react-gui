...
import { Animated, Easing, TextInput, ScrollView, View, TouchableOpacity, Keyboard } from 'react-native'
          ...
          <View style={{ position: 'relative', top: 66 }}>
            ...
            {this.state.subCategorySelectVisibility && (
              ...
              >
                ...
                <SubCategorySelect onPressFxn={this.onSelectSubCategory} enteredSubcategory={this.state.subCategory} usableHeight={platform.usableHeight} subcategoriesList={sortedSubcategories} />
              </Animated.View>
            )}

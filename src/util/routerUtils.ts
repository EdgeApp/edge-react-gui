...
export function getNavigationAbsolutePath(
...
export function getTopMostNavigation(
  navigation: NavigationProp<ParamListBase>
...
export function navigationStateToPath(
  navigationState: NavigationState | PartialState<NavigationState>,
  basePath: string = ''
): string {
  if (navigationState.routes == null || navigationState.index == null)
    return basePath

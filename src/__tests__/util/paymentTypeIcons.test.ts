import {
  getPaymentTypeIcon,
  getPaymentTypeThemeKey
} from '../../util/paymentTypeIcons'
...
describe('paymentTypeIcons', () => {
  const mockTheme = {
    ...
    paymentTypeLogoCashApp: { uri: 'cash-app-icon.png' },
  ...
  describe('getPaymentTypeThemeKey', () => {
    it('should return correct theme key for known payment types', () => {
      ...
      expect(getPaymentTypeThemeKey('cashapp')).toBe('paymentTypeLogoCashApp')
    })
  ...
  describe('getPaymentTypeIcon', () => {
    it('should return correct icon for known payment types', () => {
      ...
      expect(getPaymentTypeIcon('cashapp', mockTheme)).toEqual({
        uri: 'cash-app-icon.png'
      })
    })

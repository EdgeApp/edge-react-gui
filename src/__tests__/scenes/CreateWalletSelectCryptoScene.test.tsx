        ...
        currencyConfig: {
          ethereum: makeFakeCurrencyConfig(ethCurrencyInfo, {
            '1985365e9f78359a9b6ad760e32412f4a445e862': {
              currencyCode: 'REP',
              denominations: [
                { name: 'REP', multiplier: '1000000000000000000' }
              ],
              displayName: 'Augur',
              networkLocation: {
            ...
            '221657776846890989a759ba2973e427dff5c9bb': {
              currencyCode: 'REPV2',
              denominations: [
                { name: 'REPV2', multiplier: '1000000000000000000' }
              ],
            ...
            '2e91e3e54c5788e9fdd6a181497fdcea1de1bcc1': {
              currencyCode: 'HERC',
              denominations: [
                { name: 'HERC', multiplier: '1000000000000000000' }
              ],
            ...
            '6b175474e89094c44da98b954eedeac495271d0f': {
              currencyCode: 'DAI',
              denominations: [
                { name: 'DAI', multiplier: '1000000000000000000' }
              ],
    ...
    const rendered = render(
      <FakeProviders initialState={mockState}>
        <CreateWalletSelectCryptoScene
          {...fakeEdgeAppSceneProps('createWalletSelectCrypto', {})}
        />
      </FakeProviders>
    )

    ...
    const rendered = render(
      <FakeProviders>
        <View style={{ flex: 1 }}>
          ...
          />
          <EdgeRow
            title="Row with Icon (editable)"
            body="This row has an icon"
            icon={testIconUri}
            rightButtonType="editable"
          />
          <EdgeRow
            title="Row with Icon (questionable)"
            body="This row has an icon"
            icon={testIconUri}
            rightButtonType="questionable"
          />
          <EdgeRow
            title="Row with Icon (touchable)"
            body="This row has an icon"
            icon={testIconUri}
            rightButtonType="touchable"
          />
          <EdgeRow
            title="Row with Icon (delete)"
            body="This row has an icon"
            icon={testIconUri}
  ...
  it('renders correctly with flex: 1 children', () => {
    const rendered = render(
      <FakeProviders>
        ...
        <EdgeRow
          title="Questionable w/ Flex Children"
          icon={testIconUri}
          rightButtonType="questionable"
        >
          <View style={{ flex: 1, backgroundColor: testColor }} />
        ...
        <EdgeRow
          title="Editable w/ Flex Children"
          icon={testIconUri}
          rightButtonType="editable"
        >
          <View style={{ flex: 1, backgroundColor: testColor }} />
        ...
        <EdgeRow
          title="Touchable w/ Flex Children"
          icon={testIconUri}
          rightButtonType="touchable"
        >
          <View style={{ flex: 1, backgroundColor: testColor }} />

...
[`src/types/DeepLinkTypes.ts`](https://github.com/EdgeApp/edge-react-gui/blob/develop/src/types/DeepLinkTypes.ts)
```typescript
...
[`src/util/DeepLinkParser.ts`](https://github.com/EdgeApp/edge-react-gui/blob/develop/src/util/DeepLinkParser.ts)
```typescript
...
[`src/actions/DeepLinkingActions.tsx`](https://github.com/EdgeApp/edge-react-gui/blob/develop/src/actions/DeepLinkingActions.tsx)
```typescript
...
[`src/components/scenes/RampCreateScene.tsx`](https://github.com/EdgeApp/edge-react-gui/blob/develop/src/components/scenes/RampCreateScene.tsx)
```typescript
...
[`src/reducers/RootReducer.ts`](https://github.com/EdgeApp/edge-react-gui/blob/develop/src/reducers/RootReducer.ts)
```typescript
linkPromo: (
...
[`src/hooks/useTabBlur.ts`](https://github.com/EdgeApp/edge-react-gui/blob/develop/src/hooks/useTabBlur.ts)
```typescript
...
[`src/util/tracking.ts`](https://github.com/EdgeApp/edge-react-gui/blob/develop/src/util/tracking.ts)
```typescript
return (dispatch, getState) => {
...
[`src/actions/WalletListActions.tsx`](https://github.com/EdgeApp/edge-react-gui/blob/develop/src/actions/WalletListActions.tsx)
```typescript

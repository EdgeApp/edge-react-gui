...
<!-- tdd-code-fingerprint: 7af9ca6df521c913f08ec231001450c9784beb6a -->
...
[`src/types/types.ts`](https://github.com/EdgeApp/edge-react-gui/blob/0565cc707eb35f7b46a31d2f4f86573e6a3406f8/src/types/types.ts)
```ts
...
[`src/components/scenes/SendScene2.tsx`](https://github.com/EdgeApp/edge-react-gui/blob/0565cc707eb35f7b46a31d2f4f86573e6a3406f8/src/components/scenes/SendScene2.tsx)
```ts
...
[`src/util/stealthSwap.ts`](https://github.com/EdgeApp/edge-react-gui/blob/0565cc707eb35f7b46a31d2f4f86573e6a3406f8/src/util/stealthSwap.ts)
```ts
...
[`src/components/tiles/AddressTile2.tsx`](https://github.com/EdgeApp/edge-react-gui/blob/0565cc707eb35f7b46a31d2f4f86573e6a3406f8/src/components/tiles/AddressTile2.tsx)
```ts
  onUnparsedAddress?: (
    address: string,
...
[`src/util/houdiniChains.ts`](https://github.com/EdgeApp/edge-react-gui/blob/0565cc707eb35f7b46a31d2f4f86573e6a3406f8/src/util/houdiniChains.ts)
```ts
...
`HOUDINI_CHAINS` is a snapshot of Houdini's mainnet native tokens (v2 partner API, re-fetched 2026-09-10) intersected with Edge pluginIds. The table holds 37 chains, 6 of them [memo](#memo)-required (`cosmoshub`, `hedera`, `ripple`, `stellar`, `thorchainrune`, `ton`). Four of the provider's published regexes are corrected in the table; see [Decision: correct the provider's address regexes rather than route around them](#correct-the-providers-address-regexes-rather-than-route-around-them). `hasSelfPrivate` is covered in [Same-asset private capability](#same-asset-private-capability).
...
[`src/util/paymentUri.ts`](https://github.com/EdgeApp/edge-react-gui/blob/0565cc707eb35f7b46a31d2f4f86573e6a3406f8/src/util/paymentUri.ts)
```ts
...
[`src/actions/SwapSendWarningActions.tsx`](https://github.com/EdgeApp/edge-react-gui/blob/0565cc707eb35f7b46a31d2f4f86573e6a3406f8/src/actions/SwapSendWarningActions.tsx)
```ts
...
[`src/components/themed/PriceImpactText.tsx`](https://github.com/EdgeApp/edge-react-gui/blob/0565cc707eb35f7b46a31d2f4f86573e6a3406f8/src/components/themed/PriceImpactText.tsx)
```ts

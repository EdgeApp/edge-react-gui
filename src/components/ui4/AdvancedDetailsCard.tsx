  ...
  render() {
    ...
    return (
      <CardUi4>
        ...
        {receiveAddressesString != null && <RowUi4 type="static" title={lstrings.my_receive_addresses_title} body={receiveAddressesString} />}
        {networkFeeOption != null && <RowUi4 type="static" title={lstrings.transaction_details_advance_details_fee_setting} body={this.renderFeeOptions()} />}
        {feeRateUsed != null && <RowUi4 type="static" title={lstrings.transaction_details_advance_details_fee_used} body={this.renderFees(feeRateUsed)} />}
        ...
        {deviceDescription != null && <RowUi4 type="static" title={lstrings.transaction_details_advance_details_device} body={deviceDescription} />}
      </CardUi4>
    )
  }
}

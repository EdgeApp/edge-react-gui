...
import { BuyCrypto } from './BuyCrypto.js'
import { guessFromCurrencyCode } from './CurrencyIcon.js'
import { EmptyLoader, SectionHeader, SectionHeaderCentered } from './TransactionListComponents.js'
import { TransactionListRow } from './TransactionListRow.js'
...
export function TransactionList({ walletId, currencyCode, searching = false, searchString }: Props) {
  ...
  const { pluginId, tokenId } = guessFromCurrencyCode(account, { currencyCode })
  ...
  // TODO: Change this to get the list of blogs
  // from the CDN
  useEffect(() => {

 ...
 */
export const SwipeableRow = React.forwardRef<SwipableRowRef, Props>(
  (props: Props, ref) => {
    ...
    return (
      <GestureDetector gesture={panGesture}>
        <View style={styles.container} onLayout={handleLayout}>
          {renderLeft == null ? null : (
            <Animated.View
              style={[styles.underlay, styles.underlayLeft, leftStyle]}
            >
              {renderLeft(leftActive)}
            </Animated.View>
          )}
          {renderRight == null ? null : (
            <Animated.View
              style={[styles.underlay, styles.underlayRight, rightStyle]}
            >
              {renderRight(rightActive)}
            </Animated.View>
          )}
          <Animated.View style={[styles.childContainer, childStyle]}>
            {children}
          </Animated.View>
        </View>
      </GestureDetector>

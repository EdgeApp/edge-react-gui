...
export const TransactionListTop = connect<StateProps, DispatchProps, OwnProps>(
  state => {
    ...
    const currencyDenomination = getDisplayDenomination(state.ui.settings, currencyInfo, selectedCurrencyCode)
    ...
    const defaultDenomination = getDefaultDenomination(currencyInfo, selectedCurrencyCode)

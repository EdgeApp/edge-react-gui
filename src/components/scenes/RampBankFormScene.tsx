...
export const RampBankFormScene = (props: Props): React.JSX.Element => {
  ...
  const [bankName, setBankName] = React.useState('Bank of America')
  const [accountNumber, setAccountNumber] = React.useState('65481932')
  const [routingNumber, setRoutingNumber] = React.useState('069779628')
  const [accountName, setAccountName] = React.useState('John Smith')
  const [accountOwnerName, setAccountOwnerName] = React.useState('John Smith')

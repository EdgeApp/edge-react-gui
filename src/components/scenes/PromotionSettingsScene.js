...
export class PromotionSettingsComponent extends React.Component<Props> {
  render() {
    const { accountReferral, deviceReferral, removePromotion, theme } =
      this.props
    ...
    return (
      <SceneWrapper background="theme" hasTabs={false}>
        <SettingsHeaderRow
          text={s.strings.settings_promotion_affiliation_header}
        />
        <View style={styles.textBlock}>
          <Text style={styles.textRow}>
            {deviceReferral.installerId == null
              ...
              : sprintf(
                  s.strings.settings_promotion_device_installer,
                  deviceReferral.installerId
                )}
          </Text>
          {deviceReferral.currencyCodes != null ? (
            <Text style={styles.textRow}>
              {sprintf(
                s.strings.settings_promotion_device_currencies,
                deviceReferral.currencyCodes.join(', ')
              )}
            </Text>
          ) : null}
          <Text style={styles.textRow}>
            {accountReferral.installerId == null
              ...
              : sprintf(
                  s.strings.settings_promotion_account_installer,
        ...
        <SettingsRow
          text={s.strings.settings_promotion_add}
          right={addIcon}
  ...
  handleAdd = () => {
    launchModal(
      ...
      if (installerId != null) {
        showActivity(
          sprintf(s.strings.settings_promotion_adding, installerId),
          this.props.activatePromotion(installerId)
        )
      }
    })
  }

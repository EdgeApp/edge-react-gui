  ...
  return (
    <SceneWrapper scroll>
      <SceneContainer headerTitle={lstrings.how_duress_mode_works}>
        ...
        <CardHeadingText>
          {lstrings.how_duress_mode_return_to_normal_title}
        </CardHeadingText>
        <EdgeCard>
          {parseMarkdown(
        ...
        <CardHeadingText>
          {lstrings.how_duress_mode_add_funds_to_account_title}
        </CardHeadingText>
        <EdgeCard>
          {parseMarkdown(
        ...
        <CardHeadingText>
          {lstrings.how_duress_mode_when_to_use_title}
        </CardHeadingText>
        <EdgeCard>
          {parseMarkdown(lstrings.how_duress_mode_when_to_use_description_md)}
        </EdgeCard>

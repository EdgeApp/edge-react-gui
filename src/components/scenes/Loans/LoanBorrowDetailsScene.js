...
import { useCryptTextActually } from '../../text/CryptoText'
...
export const LoanBorrowDetailsScene = (props: Props) => {
  ...
  const borrowTotalValue = useCryptTextActually({ wallet, tokenId: selectedTokenId, nativeAmount: selectedNativeAmount })

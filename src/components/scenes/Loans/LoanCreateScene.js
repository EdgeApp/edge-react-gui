...
export const LoanCreateScene = (props: Props) => {
  ...
  const srcAssetName = useMemo(
    () => (srcToken != null ? srcToken.displayName : srcWallet != null ? srcWallet.currencyInfo.displayName : ''),
    [srcToken, srcWallet]
  )
  ...
  const destToken = useMemo(
    () => (destTokenId != null && destPluginId != null ? allTokens[destPluginId][destTokenId] : {}),
    [allTokens, destPluginId, destTokenId]
  )

...
export class TransactionDetailsComponent extends React.Component<Props, State> {
  ...
  openFiatInput = () => {
    Airship.show(bridge => (
      <TransactionDetailsFiatInput bridge={bridge} currency={this.props.guiWallet.fiatCurrencyCode} amount={this.state.amountFiat} />
    )).then(amountFiat => this.onSaveTxDetails(amountFiat))
  }
  ...
  openCategoryInput = () => {
    Airship.show(bridge => (
      ...
      />
    )).then(categoryData => this.onSaveTxDetails(categoryData))
  }
  ...
  openNotesInput = () => {
    Airship.show(bridge => (
      ...
      />
    )).then(notes => this.onSaveTxDetails({ notes }))
  }
  ...
  onSaveTxDetails = (newDetails: any | null) => {

        ...
        {denominations.map(denomination => {
          ...
          return (
            <SettingsRadioRow
              ...
              value={isSelected}
              onPress={() => selectDenomination(currencyInfo.pluginId, currencyCode, denomination)}
            >
...
export const CurrencySettingsScene = connect<StateProps, DispatchProps, OwnProps>(
  (state, { route: { params } }) => ({
    ...
    selectedDenominationMultiplier: getDisplayDenomination(state.ui.settings, state.core.account.currencyConfig[params.currencyInfo.pluginId].currencyInfo)
      .multiplier
  }),
  dispatch => ({

...
class CryptoExchangeComponent extends React.Component<Props, State> {
  ...
  render() {
    ...
    console.log('258. fromFiatCurrencyCode', fromFiatCurrencyCode)
    if (fromFiatCurrencyCode !== '') {
      fromSecondaryInfo = {
        displayCurrencyCode: 'hello',
        exchangeCurrencyCode: 'hello2',
    ...
    if (toFiatCurrencyCode !== '') {
      toSecondaryInfo = {
        displayCurrencyCode: 'hello3',
        exchangeCurrencyCode: 'hello4',
    ...
    console.log('print this shit', this.props.fromWalletPrimaryInfo, fromSecondaryInfo, this.props.fromFiatToCrypto, this.state.fromExchangeAmount)
...
export const CryptoExchangeScene = connect<StateProps, DispatchProps, {}>(
  state => {
    ...
    if (toWalletId != null) {
      ...
      const { name: toWalletName, fiatCurrencyCode: toFiatCurrencyCode } = currencyWallets[toWalletId]

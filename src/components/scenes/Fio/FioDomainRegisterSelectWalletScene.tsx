...
> {
  ...
  render() {
    ...
    const detailsText = sprintf(
      lstrings.fio_domain_wallet_selection_text,
      config.appName,
    ...
    if (paymentWallet != null && paymentWallet.id !== '') {
      ...
      paymentWalletBody = `${getWalletName(wallet)} (${
        ...
        <View style={styles.container}>
          ...
          <EdgeCard>
            <EdgeRow
              ...
              body={loading ? lstrings.loading : `${activationCost} ${FIO_STR}`}
            />
          </EdgeCard>
          <EdgeCard>
            <EdgeRow
...
const FioDomainRegisterSelectWalletConnected = connect<
  StateProps,
  DispatchProps,
  OwnProps
>(
...
export const FioDomainRegisterSelectWalletScene = withWallet(
  FioDomainRegisterSelectWalletConnected
)

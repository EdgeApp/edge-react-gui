  ...
  const handleToggleVerboseLogging = useHandler(() => {
    ...
    context
      .changeLogSettings({
        ...
        sources: {
          // { [pluginId: string]: EdgeLogType | 'silent' }
          amoy: 'silent',
          arbitrum: 'silent',
          algorand: 'silent',
          avalanche: 'silent',
          ...
          base: 'silent',
          binance: 'silent',
          binancesmartchain: 'silent',
          bobevm: 'silent',
          cardano: 'silent',
          cardanotestnet: 'silent',
          celo: 'silent',
          coreum: 'silent',
          cosmoshub: 'silent',
          eos: 'silent',
          ethereum: 'silent',
          ethereumclassic: 'silent',
          ethereumpow: 'silent',
          fantom: 'silent',
          filecoin: 'silent',
          filecoinfevm: 'silent',
          filecoinfevmcalibration: 'silent',
          fio: 'silent',
          hedera: 'silent',
          holesky: 'silent',
          liberland: 'silent',
          liberlandtestnet: 'silent',
          optimism: 'silent',
          osmosis: 'silent',
          // piratechain: 'silent',
          polkadot: 'silent',
          ...
          bitcoin: 'silent',
          bitcoincash: 'silent',
          bitcoincashtestnet: 'silent',
          bitcoingold: 'silent',
          bitcoingoldtestnet: 'silent',
          bitcoinsv: 'silent',
          bitcointestnet: 'silent',
          dash: 'silent',
          digibyte: 'silent',
          dogecoin: 'silent',
          eboost: 'silent',

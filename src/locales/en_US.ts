...
const strings = {
  ...
  ctx_spend_section_title: 'CTX Spend (Prototype)',
  ctx_spend_connect_button: 'Connect to CTX Spend',
  ctx_spend_connecting: 'Connecting...',
  ctx_spend_not_configured:
    'CTX Spend is not configured. Add PLUGIN_API_KEYS.ctxSpend to env.json.',
  ctx_spend_unavailable_light_account:
    'CTX Spend requires a full account. Light accounts cannot store the signing key.',
  ctx_spend_public_key: 'CTX Public Key',
  ctx_spend_user_id: 'CTX User ID',
  ctx_spend_user_name: 'CTX User Name',

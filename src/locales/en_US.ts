...
const strings = {
  ...
  loan_repay_insufficient_collateral:
    'Requested collateral amount to swap for principal payment would cause liquidation. Please specify another payment source or lower payment amount.',
  loan_apr_1s: 'APR: %1$s',

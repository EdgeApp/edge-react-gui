...
const strings = {
  ...
  request_lld_minimum_notification_body:
    'Liberland (LLD) wallets require a 0.01 LLD minimum balance. You must deposit at least 0.01 LLD to this address before this wallet will show a balance or transactions. 0.01 LLD will be unspendable for the lifetime of this wallet address.',
  request_lld_minimum_notification_alert_body: 'This wallet will always require a 0.01 LLD minimum',

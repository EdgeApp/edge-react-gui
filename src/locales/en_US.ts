...
const strings = {
  ...
  wallet_share_chooser_receive_subtitle:
    'Receive shared wallets from another device',
  wallet_share_scan_title: 'Scan QR code of recipient account',
  wallet_share_scan_text_title: 'Enter share link',
  wallet_share_scan_text_hint: 'Share link',
  ...
  wallet_share_confirm_warning_body:
    'Granting spend access will allow full spending ability to the recipient account of the shared wallets. Access to shared wallets cannot be revoked.',

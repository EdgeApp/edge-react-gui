...
const strings = {
  ...
  houdini_swap_title: 'Swap',
  houdini_quote_title: 'Confirm Swap',
  houdini_swap_from_wallet: 'From wallet',
  houdini_swap_to_wallet: 'To wallet',
  houdini_swap_to: 'Swap to',
  houdini_you_receive: 'You receive',
  houdini_rate: 'Rate',
  houdini_provider_name: 'Houdini',
  houdini_slide_get_quote: 'Slide to get quote',
  houdini_slide_swap: 'Slide to confirm swap',

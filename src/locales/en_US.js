...
const strings = {
  ...
  scan_invalid_token_error_title: 'Invalid Token',
  scan_invalid_token_error_description: 'Not a valid token contract',
  ...
  scan_address_add_token_exists_err_message: 'Token %1s already exists for %2s wallet',

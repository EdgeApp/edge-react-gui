...
const strings = {
  ...
  stake_unstake_and_claim_rewards: 'Unstake and Claim Rewards',
  ...
  stake_change_stake_success: 'Staked successfully',
  stake_change_unstake_success: 'Unstaked successfully',
  stake_change_claim_success: 'Claimed successfully',
  stake_disabled_slider: 'Enter Amount',
  stake_warning_stake:
    'Staking funds will lock withdrawals for 36 hours and rewards for 18 hours.\n\nEvery interaction (stake, unstake, or claim rewards) will reset both timers.',
  stake_warning_claim:

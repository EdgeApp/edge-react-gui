...
const strings = {
  ...
  wallet_list_add_token_modal_title: 'Token-Enabled Wallet Needed',
  wallet_list_add_token_modal_message: 'Please create a token-enabled wallet first to hold your tokens',

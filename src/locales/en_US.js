...
const strings = {
  ...
  delete_account_funds:
    'Deleting your Edge account will make any funds in your wallets inaccessible. Any future funds that these wallets may receive will also be inaccessible.',
  delete_account_partner:
    'Accounts created with Edge buy / sell partners will remain active. You will need to request deletion for any such accounts directly with the appropriate partners.',
  delete_account_devices:
  ...
  delete_account_username: "Deletion of this account will make the account's username usable for new account creation.",
  delete_account_support: 'If you have any questions or concerns, feel free to contact us, or email support@edge.app prior to deleting your account.',

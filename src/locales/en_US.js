...
const strings = {
  ...
  create_wallet_import_instructions_eosio: 'Enter your active private key to verify and restore the associated account:',
  create_wallet_import_input_prompt_eosio: 'Active Private Key',

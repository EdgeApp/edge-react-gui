...
const strings = {
  ...
  loan_create_must_be_s_or_less: 'Loan must be less than %1$s of your total collateral value',
  loan_create_amount_exceeds_s_collateral: 'Loan exceeds %1$s of collateral value in your %2$s wallet',
  loan_create_title: 'Borrow With Aave',
  loan_create_conf_amount_borrow: 'Amount to Borrow',
  loan_create_conf_title: 'Borrow Details',

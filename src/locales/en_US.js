...
const strings = {
  ...
  fragment_wallets_view_xpub_key: 'View XPub Key',
  fragment_wallets_pubkey_copied_title: 'XPub Key Copied',
  fragment_wallets_pubkey_copied_success: 'The XPub Key has been successfully copied to the clipboard.',
  fragment_wallets_pubkey_copied_error: 'There has been an error copying your XPub Key.',

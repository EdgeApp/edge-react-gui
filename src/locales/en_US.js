...
const strings = {
  ...
  loan_details_must_be_s_or_less: 'Loan must be less than %1$s of your total collateral value',
  loan_details_amount_exceeds_s_collateral: 'Loan exceeds %1$s of collateral value in your %2$s wallet',

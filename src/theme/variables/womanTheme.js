...
export const womanTheme: Theme = {
  ...
  primaryButton: '#F38FAC',
  primaryButtonText: '#efc2de',
  // primaryButtonDeactivated: palette.gray,

  secondaryButtonOutline: '#F38FAC',
  secondaryButton: palette.transparent,
  secondaryButtonText: '#F38FAC',
  ...
  cardBorder: 1,
  cardBorderColor: '#F38FAC',
  cardBorderRadius: 4,

  tabBarBackground: '#F38FAC',
  tabBarIcon: '#efc2de',
  tabBarIconHighlighted: '#6c3434',
...
const missingNumbers = (Array = [1, 2, 10]) => {
  let missing = [];

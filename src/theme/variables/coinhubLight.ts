...
export const coinhubLight: Theme = {
  ...
  backgroundDots: {
    ...
    dots: [
      ...
      {
        color: palette.backgroundPurple,
        cx: '25%',
        cy: '75%',
        r: scale(150)
      }
  ...
  assetFallbackText: palette.lightGray,
  ...
  secondaryButtonDisabled: [palette.grayOp70, palette.grayOp70],
  ...
  // Toasts
  toastBackground: palette.lightGray,

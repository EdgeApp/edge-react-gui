...
export default {
  ...
  badgePadding: (platform === 'ios') ? 3 : 0,
    ...
    // Button
  btnFontFamily: (platform === 'ios') ? 'Source Sans Pro' : 'Roboto_medium',
  ...
  brandSideMenu: '#252932',
    ...
    // Font
  fontFamily: (platform === 'ios') ? 'Source Sans Pro' : 'Roboto',
  fontSizeBase: 15,
  ...
  // tabBarActiveTextColor: (platform === 'ios') ? '#007aff' : '#fff', //custom
  tabBarActiveTextColor: (platform === 'ios') ? '#4977BB' : '#fff',
  ...
  usableHeight: deviceHeight - ((platform === 'ios') ? 44 : 62) - 69,  // device - toolbar - footer

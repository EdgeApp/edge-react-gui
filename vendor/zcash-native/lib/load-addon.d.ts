export interface NativeZcashAddon {
    ...
    initialize: (mnemonicSeed: string, birthdayHeight: number, alias: string, networkName: string, defaultHost: string, defaultPort: number, newWallet: boolean) => Promise<void>;
    ...
    proposeTransfer: (alias: string, zatoshi: string, toAddress: string, memo?: string) => Promise<string>;
    createTransfer: (alias: string, proposalBase64: string, mnemonicSeed: string) => Promise<string>;
    broadcastTransfer: (alias: string, txid: string) => Promise<string>;
    shieldFunds: (alias: string, seed: string, memo: string, threshold: string) => Promise<string>;
    proposeOrchardToIronwoodMigration: (alias: string) => Promise<string>;
    proposeFulfillingPaymentUri: (alias: string, paymentUri: string) => Promise<string>;
    emitExistingTransactions: (alias: string) => Promise<void>;
}
export declare function loadNativeAddon(): NativeZcashAddon;

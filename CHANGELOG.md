...
- added: MoonPay Trade (swaps.xyz) swap provider wiring (SWAPSXYZ_INIT core plugin init and registration) as two entries: "MoonPay Trade (Centralized)" and the DEX-classified "MoonPay Trade (DeFi)" for Solana-to-Solana routes.
